// Contact Form - Updated January 29, 2025
function noop() { }
const identity = x => x;
...
function instance($$self, $$props, $$invalidate) {
	...
	return [form, heading, submitting, submitted, error, submit_form, props];
}

class Component extends SvelteComponent {
	constructor(options) {
		super();
		init(this, options, instance, create_fragment, safe_not_equal, { props: 6, form: 0, heading: 1 });
	}
}
